    ...
    <div className="min-h-screen bg-[#F8F9FA] flex flex-col justify-center items-center p-4 font-sans">
      <div className="w-full max-w-[440px] bg-white rounded-xl shadow-[0_2px_20px_rgba(0,0,0,0.04)] border border-gray-100 p-8 sm:p-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-[22px] font-semibold text-gray-900 mb-2">Sign in to Admin Console</h2>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            <div className="space-y-4">
              ...
              <div className="flex items-end justify-end mb-1">
                <button 
                  type="button"
                  className="text-[13px] font-bold text-[#0A4297] hover:text-blue-800 bg-transparent border-none p-0 cursor-pointer"
                >
                  Forgot password?
                </button>
              </div>
